...
User.new(fname: 'AAA', lname: 'XXX', username: 'aaa', user_type: 'teenager', email: 'aaa.xxx@mail.utoronto.ca', address: '40 St George St', city: 'Toronto', country: 'Canada', lat: 43.6596184, long: -79.39692079999999).save(validate: false)
